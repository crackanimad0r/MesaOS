...
pub fn exec_user_from_slice(name: &str, code: &[u8]) -> u64 {
    crate::serial_println!(
        "[EXEC] Creating user process '{}' ({} bytes)",
        name,
        code.len()
    );
...
pub mod programs {
    ...
    pub const COUNTER: [u8; 76] = [
        ...
        // mov rdi, 1
        0x48, 0xc7, 0xc7, 0x01, 0x00, 0x00, 0x00,
        // lea rsi, [rip+32]  -> 0x10001c+32 = 0x10003c (cadena "Counter!")
        0x48, 0x8d, 0x35, 0x20, 0x00, 0x00, 0x00,
        // mov rdx, 10
