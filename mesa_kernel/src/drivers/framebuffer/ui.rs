...
impl UiRenderer {
        ...
        for dy in 0..r * 2 {
            for dx in 0..r * 2 {
                ...
                if dist <= r as f32 {
                    let t = dist / r as f32;
                    let color = Color::new(
                        (center_color.r as f32 + (edge_color.r as f32 - center_color.r as f32) * t)
                            as u8,
                        (center_color.g as f32 + (edge_color.g as f32 - center_color.g as f32) * t)
                            as u8,
                        (center_color.b as f32 + (edge_color.b as f32 - center_color.b as f32) * t)
                            as u8,
                    );
    ...
    pub fn draw_top_bar(&self, title: &str) {
        ...
        self.fill_circle(
            btn_start + btn_spacing,
            btn_y,
            btn_radius,
            Color::new(255, 189, 46),
        );
        self.fill_circle(
            btn_start + 2 * btn_spacing,
            btn_y,
            btn_radius,
            Color::new(39, 201, 63),
        );
    ...
    pub fn draw_background(&self) {
        for y in 0..self.height {
            for x in 0..self.width {
                ...
                let r = (palette::BASE.r as f32
                    + (palette::SURFACE.r as f32 - palette::BASE.r as f32) * t * 0.5)
                    as u8;
                let g = (palette::BASE.g as f32
                    + (palette::SURFACE.g as f32 - palette::BASE.g as f32) * t * 0.5)
                    as u8;
                let b = (palette::BASE.b as f32
                    + (palette::SURFACE.b as f32 - palette::BASE.b as f32) * t * 0.5)
                    as u8;
    ...
    pub fn draw_text(&self, x: usize, y: usize, text: &str, color: Color) {
        use super::font::{get_char, FONT_HEIGHT, FONT_WIDTH};
