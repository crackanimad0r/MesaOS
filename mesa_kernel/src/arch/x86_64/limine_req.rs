...
// ══════════════════════════════════════════════════════════════════════════════
// UEFI RUNTIME SERVICES (placeholder - requires limine protocol support)
// ══════════════════════════════════════════════════════════════════════════════

/// Placeholder: Obtener RuntimeServices requiere soporte del bootloader
/// En la práctica, Limine v0.5 pasa EFI_SYSTEM_TABLE a través de su protocolo
/// de boot. Para obtenerlo, se necesita usar limine::request::UefiBootServicesRequest
/// que está disponible en versiones recientes de la crate limine.
///
/// Mientras tanto, la inicialización se hace con un puntero nulo y se setea
/// externamente desde el entry point si se tiene acceso a EFI_SYSTEM_TABLE.
pub fn uefi_runtime_services() -> Option<*const core::ffi::c_void> {
    None // No disponible con limine v0.5 actual
}
